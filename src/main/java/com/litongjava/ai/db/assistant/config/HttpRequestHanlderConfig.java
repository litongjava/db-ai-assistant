...
public class HttpRequestHanlderConfig {
  ...
  public void config() {
    ...
    r.add("/getAllTableColumnsOfMarkdown", getConfigHandler::getAllTableColumnsOfMarkdown);
    r.add("/getAllTableDataExamplesOfMarkdown", getConfigHandler::getAllTableDataExamplesOfMarkdown);
